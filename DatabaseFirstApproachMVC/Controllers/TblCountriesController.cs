...
using DatabaseFirstApproachMVC.Models;

namespace DatabaseFirstApproachMVC.Controllers
{
    public class TblCountriesController : Controller
    {
        private readonly DbTestContext _context;

        public TblCountriesController(DbTestContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Capital,Population,Economy,Currency")] TblCountry tblCountry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Capital,Population,Economy,Currency")] TblCountry tblCountry)
        {
            if (id != tblCountry.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbTestContext.TblCountries'  is null.");
            }
            var tblCountry = await _context.TblCountries.FindAsync(id);
            if (tblCountry != null)
            {
